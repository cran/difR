...
\value{ 
 ...
 \item{deviance}{the values of the logistic regression DIF statistics.}
...
\details{
 ...
 \code{type="both"} (default) which tests the hypothesis \eqn{H_0: \gamma_1 = \delta_1=0} by comparing models \eqn{M_0} and \eqn{M_2}; \code{type="nudif"} which 
 tests the hypothesis \eqn{H_0: \delta_1 = 0} by comparing models \eqn{M_0} and \eqn{M_1}; and \code{type="udif"} which tests the hypothesis
 \eqn{H_0: \gamma_1 = 0} by comparing models \eqn{M_1} and \eqn{M_2} (assuming that \eqn{\delta_1 = 0}). In other words, \code{type="both"} tests for
